...
@section('main')
  ...
  @include('kadmin.partials.entete', ['title' => trans('back/blog.dashboard') . link_to_route('kadmin.articles.create', trans('back/blog.add'), [], ['class' => 'btn btn-info pull-right']), 'icone' => 'pencil', 'fil' => trans('back/blog.posts')])
