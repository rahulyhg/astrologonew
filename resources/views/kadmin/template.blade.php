                    ...
                    @if(session('statut') == 'admin')
                        ...
                        <li {!! classActiveSegment(1, 'user') !!}>
                            ...
                            <ul id="usermenu" class="collapse">
                                <li><a href="{!! url('kadmin/user') !!}">{{ trans('back/admin.see-all') }}</a></li>
                                <li><a href="{!! url('user/create') !!}">{{ trans('back/admin.add') }}</a></li>
                                <li><a href="{!! url('user/roles') !!}">{{ trans('back/roles.roles') }}</a></li>
                            </ul>
                        </li>
                        <li {!! classActivePath('kadmin/contacts') !!}>
                            <a href="{!! url('kadmin/contacts') !!}"><span class="fa fa-fw fa-envelope"></span> {{ trans('back/admin.messages') }}</a>
                        </li>
                        <li {!! classActivePath('comment') !!}>
                            <a href="{!! url('comment') !!}"><span class="fa fa-fw fa-comments"></span> {{ trans('back/admin.comments') }}</a>
                        </li>
                    @endif
                    <li {!! classActivePath('kadmin/medias') !!}>
                        <a href="{!! route('kadmin/medias') !!}"><span class="fa fa-fw fa-file-image-o"></span> {{ trans('back/admin.medias') }}</a>
                    </li>
                    <li {!! classActiveSegment(1, 'kadmin/articles/') !!}>
                        ...
                        <ul id="articlemenu" class="collapse">
                            <li><a href="{!! url('kadmin/articles/') !!}">{{ trans('back/admin.see-all') }}</a></li>
                            <li><a href="{!! url('kadmin/articles/create') !!}">{{ trans('back/admin.add') }}</a></li>
                        </ul>
                    </li>

                        <li {!! classActivePath('kadmin/category') !!}>
                            <a href="{!! url('kadmin/category') !!}"><span class="fa fa-fw fa-pencil"></span> Category</a>
                        </li>
